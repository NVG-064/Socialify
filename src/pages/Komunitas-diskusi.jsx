            ...
            <section className="bg-komunitas col-span-2 row-span-2">
              <div class="w-full px-4 md:w-4/5 xl:w-[60rem] mx-auto">
                <div class="mb-3 overflow-hidden rounded-2xl bg-purple-sosialify">
                  ...
                  <p class="lg:p-9 p-5 lg:text-base text-justify text-sm leading-relaxed text-white">
            ...
            <section className="bg-komunitas col-span-2 row-span-2">
              <div class="w-full px-4 md:w-4/5 xl:w-[60rem] mx-auto">
                <div class="mb-3 overflow-hidden rounded-3xl bg-purple-sosialify">
                  ...
                  <p class="p-5 lg:p-9 lg:text-base text-sm leading-relaxed text-white">
            ...
            <section className="bg-komunitas col-span-2 row-span-2">
              <div class="w-full px-4 md:w-4/5 xl:w-[60rem] mx-auto">
                <div class="mb-3 overflow-hidden rounded-3xl bg-purple-sosialify">
                  ...
                  <p class="lg:p-9 p-5 lg:text-base text-sm leading-relaxed text-white">
