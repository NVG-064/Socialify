    ...
    return (
        <div className="bg-[#20043F] text-white">
            ...
            <div>
                ...
                <button onClick={() => navigate('/komunitas/event')} className="absolute top-[15%] ml-16">
                ...
                <div className="w-full h-auto absolute top-[23%] flex flex-col items-center justify-center text-white">
                    ...
                    <div className="mt-[32px] w-[30%] flex flex-row items-center justify-center gap-3">
                        <button onClick={() => navigate('/event/live-audio/gabung')} className="w-full h-auto bg-[#ffbe3f] font-medium py-2 rounded-[10px] text-black">Gabung</button>
