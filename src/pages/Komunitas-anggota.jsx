        ...
        <div>
          ...
          <div className="col-span-2 row-span-2 mt-10">
            <section className="bg-komunitas col-span-2 row-span-2">
              <div class="w-full px-4 pb-4 md:w-4/5 xl:w-[60rem] mx-auto">
                <div class="mb-3 overflow-hidden rounded-2xl bg-purple-sosialify">
                  ...
                  <div>
                    ...
                    <div class="px-3 pb-2 lg:px-9 lg:pb-5 lg:mx-1 border-b-2">
                      <div class="relative lg:mb-4 flex w-full lg:flex-wrap items-stretch bg-[#D9D9D9] rounded-2xl">
                        <button
                          class="relative z-[2] px-3 py-2 lg:px-6  text-xs font-medium uppercase text-primary transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
                          type="button"
                          id="button-addon3"
                          data-te-ripple-init
                        >
                        ...
                        <input
                          type="search"
                          class="relative w-full lg:w-auto -mr-0.5 block lg:flex-auto bg-transparent bg-clip-padding py-[0.25rem] text-base font-normal leading-[1.6] text-neutral-700 outline-none transition duration-200 ease-in-out focus:z-[3] focus:text-neutral-700 focus:outline-none"
                          placeholder="Cari Anggota"
                          aria-label="Search"
                          aria-describedby="button-addon3"
                        />
                        <button
                          class="relative z-[2] lg:px-6 p-2 text-xs font-medium uppercase text-primary transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
                          type="button"
                          id="button-addon3"
                          data-te-ripple-init
                        >
