      ...
      <div className="bg-purple-sosialify drop-shadow-xl pt-4">
        <div className="w-4/5 md:w-4/6 mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-start gap-3 mt-2.5 pb-5 xl:ml-28 text-center">
            <NavLink role="button" to={"/profil-tentang"} className="bg-white rounded-lg py-0.5 px-5">Tentang</NavLink>
            <NavLink role="button" to={"/profil-komunitas"} className="bg-white rounded-lg py-0.5 px-5">Komunitas</NavLink>
            <NavLink role="button" to={"/profil-linimasa"} className="bg-white rounded-lg py-0.5 px-5">
              Linimasa
            </NavLink>
          </div>
        </div>
